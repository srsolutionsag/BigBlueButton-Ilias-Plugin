...
This is a [ILIAS](https://www.ilias.de) Plugin which allows the creation of [BigBlueButton](https://bigbluebutton.org) Virtual Classrooms inside ILIAS.
...
It is assumed you already have a ILIAS Installation [up and running](https://docu.ilias.de/goto_docu_pg_116903_367.html).
...
**Note:** it is assumed that you are in the ILIAS web root directory
...
- now hit the `configure` link and enter your 
    - public or private server URL : {PROTOCOL}://{SERVER_ADDRESS}{:PORT}/{BBB_SUBPATH}/. Where 
        ...
        - {BBB_SUBPATH}: The subpath of BBB Server. E.g.: /bigbluebutton/
